...
int main(void)
{
    ...
    char needle1[] = "world";
    printf("Test 1: %s\n", ft_strnstr(haystack1, needle1, 13));  // Should print: world!

    // Test 2: Match at the very beginning
    char haystack2[] = "Hello, world!";
    char needle2[] = "Hello";
    printf("Test 2: %s\n", ft_strnstr(haystack2, needle2, 13));  // Should print: Hello, world!

    // Test 3: Match at the very end
    char haystack3[] = "Hello, world!";
    char needle3[] = "world";
    printf("Test 3: %s\n", ft_strnstr(haystack3, needle3, 13));  // Should print: world!

    // Test 4: Needle is longer than haystack
    char haystack4[] = "Hi!";
    char needle4[] = "Hello";
    printf("Test 4: %s\n", ft_strnstr(haystack4, needle4, 3));  // Should print: (null)

    // Test 5: Needle not found
    char haystack5[] = "Hello, world!";
    char needle5[] = "abc";
    printf("Test 5: %s\n", ft_strnstr(haystack5, needle5, 13));  // Should print: (null)
