...
#    Updated: 2024/11/28 16:20:11 by kchatela         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c \
		...
		ft_strnstr.c ft_atoi.c ft_calloc.c ft_strdup.c ft_substr.c ft_strjoin.c ft_strtrim.c ft_split.c#Variable containing all .c files required to build the project
